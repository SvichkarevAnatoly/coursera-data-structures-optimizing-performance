...
public class DocumentBenchmarking {
    ...
    public static void main(String[] args) {
        ...
        for (int numToCheck = start; numToCheck < numSteps * increment + start;
            ...
            timeBasicDocument(text, trials);
            timeEfficientDocument(text, trials);
        }

    }

    private static void timeBasicDocument(String text, int trials) {
        double sumEstTime = 0;
        for (int i = 0; i < trials; i++) {
            ...
            double estTime = (endTime - startTime) / 1_000_000_000.0;
            sumEstTime += estTime;
        }
        double totalEstTime = sumEstTime / trials;
        System.out.printf("%.4f\t", totalEstTime);
    }

    private static void timeEfficientDocument(String text, int trials) {
        double sumEstTime = 0;
        for (int i = 0; i < trials; i++) {
            long startTime = System.nanoTime();
